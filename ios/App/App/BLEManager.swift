...
class BLEManager: NSObject, CBCentralManagerDelegate {
  ...
  var BLEConfigs = BLEConfig(scan_period:5, scan_delay:10)
  ...
  {
    MacBluetoothsConnectedStr = UserDefaults.standard.string(forKey: "MacBluetoothsConnectedStr") ?? ""
  ...
  func scheduleBLEScan() {
    let timeInterval: TimeInterval = TimeInterval(BLEConfigs.scan_delay)
